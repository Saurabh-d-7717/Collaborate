...
.button-arounder:focus {
  ...
  <body>
    <header class="header">
      ...
      <nav class="nav-items">
        <a href="dashboard/Blog.php">Explore Blogs</a>
        <a href="dashboard/new/host.php">Host Community</a>
        <a href="dashboard/get1.php">Join Community</a>
        <a href="dashboard/home.php">Profile</a>
        <a href="dashboard/login.php"><div class="buttons-container">
  <button class="button-arounder">Login/Logout</button>
    ...
    <main>
      ...
      <div class="about-me">
        ...
        <img src="dashboard/image/img2.jpeg" alt="about us" />
      </div>
    </main>
    <footer class="footer">
